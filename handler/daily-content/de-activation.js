    ...
    require('../../dao/subscriber').getSubscriber(req, function (sub) {
        ...
        if (sub.length === 0) {
            ...
            require('../../dao/service').getProperty(req, function (shouldBeSubscriber) {
                ...
                hamrahvas.sendSMS(req.query.tel, req.query.scode, shouldBeSubscriber[0].value, req.query.service, 0, '00', function (callback) {
                });
            });
            return;
        }
        require('../../dao/subscriber').setUnSubscriber(req, function (affectedRows) {
            ...
            require('../../dao/service').getProperty(req, function (deactivation) {
                ...
                hamrahvas.sendSMS(req.query.tel, req.query.scode, deactivation[0].value, req.query.service, 41, '00', function (callback) {
                });
            });
        });
    });
